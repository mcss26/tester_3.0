# Contexto: central-stock
Generado: 2026-02-22 14:15 | Topic: `central-stock`

> Este archivo contiene todo el contexto relevante sobre **central-stock**.
...
- `pages\admin\admin-central-stock.html` (53.107 bytes, mod: 2026-02-22 10:47)
...
### Commits que mencionan 'central-stock'
- 8b0d51c fix(security): Sprint 1 - RLS + MCO_BATCH_ID + console.log cleanup

### Commits que tocan archivos *central-stock*
- 0f66978 docs
- f2f59c1 css
...
## 6. Reportes previos (2 encontrados)
...
No se encontraron conversaciones recientes sobre 'central-stock'.
