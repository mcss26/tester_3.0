...
### Compliance por categoria (solo relevantes):
  ...
  * Buttons: falta (25%) -- Missing: btn-primary, btn-secondary, btn-ghost, btn-icon-plus, btn-danger, btn-sm
...
### Hints de remediacion (priorizados):
  ...
  * LOW: [Buttons] Agregar: btn-primary, btn-secondary, btn-ghost, btn-icon-plus, btn-danger, btn-sm
