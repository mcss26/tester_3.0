# Remediacion Golden Standard: logistica-recepcion.html

## Contexto
Archivo: pages/logistica/logistica-recepcion.html
Score actual: 69/100
Modulo: logistica
...
### Compliance por categoria (solo relevantes):
  ...
  * FilterBar: falta (38%) -- Missing: pill, is-active, search-input-wrap, search-icon, filter-counter
  * Tables: parcial (67%) -- Missing: table-sticky, table-compact, sortable, sort-icon
...
Crea un plan de implementacion para remediar logistica-recepcion.html al Golden Standard.
...
5. Si la pagina tiene CSS propio (ej: assets/css/logistica-recepcion.css), refactoriza ahi
