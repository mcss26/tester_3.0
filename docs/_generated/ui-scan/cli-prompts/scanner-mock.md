# Remediacion Golden Standard: scanner-mock.html

## Contexto
Archivo: pages/operativo/scanner-mock.html
Score actual: 2/100
Modulo: operativo
...
### Compliance por categoria (solo relevantes):
  ...
  * Buttons: falta (12%) -- Missing: btn-primary, btn-secondary, btn-ghost, btn-icon, btn-icon-flat, btn-icon-plus, btn-danger
...
### Hints de remediacion (priorizados):
  ...
  * LOW: [Buttons] Agregar: btn-primary, btn-secondary, btn-ghost, btn-icon, btn-icon-flat, btn-icon-plus, btn-danger
...
Crea un plan de implementacion para remediar scanner-mock.html al Golden Standard.
...
5. Si la pagina tiene CSS propio (ej: assets/css/scanner-mock.css), refactoriza ahi
