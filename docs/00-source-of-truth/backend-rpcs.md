...
> **Generado:** 2026-02-16 | **Actualizado:** 2026-02-22 (+9 vistas) | **Método:** Auditoría cruzada Business Logic ↔ Supabase live
...
| `vw_finance_weekly`            | Financiero           | `finance_weekly_closings`, `work_days`, `cash_closings`                                                                                  |
| `vw_financial_week_live`       | Financiero           | `work_days`, `cash_closings`, `finance_payments`                                                                                         |
| `vw_night_snapshot`            | Dashboard            | `work_days`, `cash_closings`, `closing_terminals`, `bar_sessions`                                                                        |
| `vw_pnl_monthly_v`             | P&L                  | `vw_workday_pnl`, `work_days`                                                                                                            |
| `vw_reconciliation_status`     | Conciliación         | `cash_closings`, `closing_terminals`, `work_days`                                                                                        |
| `vw_stock_audit_nightly`       | Auditoría Inventario | `bar_stock_snapshots`, `bar_sessions`, `master_sku`                                                                                      |
| `vw_workday_cash_balance`      | Financiero           | `work_days`, `cash_closings`, `closing_terminals`, `cash_movements`                                                                      |
| `vw_workday_commissions`       | Nómina               | `work_days`, `staff_accruals`, `profiles`                                                                                                |
| `vw_workday_stock_variance`    | Auditoría Inventario | `bar_sessions`, `bar_stock_snapshots`, `master_sku`, `master_recipes`                                                                    |
...
> Referencia completa en `docs/00-source-of-truth/db-schema.md` § "Mapa Módulo ↔ Tabla".
