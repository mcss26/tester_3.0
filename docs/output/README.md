...
| Regla                    | Detalle                                                                                                                             |
| :----------------------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| **R1 — Output canónico** | Cada agente crea archivos SOLO en `docs/output/{agent_name}/`                                                                       |
| **R2 — Naming**          | `{YYYY-MM-DD}_{tipo}_{tema}.md`                                                                                                     |
| **R3 — Tipos válidos**   | `audit`, `plan`, `report`, `spec`, `research`, `migration`, `walkthrough`                                                           |
| **R4 — Docs core**       | Los docs canónicos (`estado-presente`, `screen-map`, `scheme`, `ui-golden-standard`, `INDEX`) solo se EDITAN, nunca se crean nuevos |
