# Remediacion Golden Standard: operativo-workday.html

## Contexto
Archivo: pages/operativo/operativo-workday.html
Score actual: 66/100
Modulo: operativo
...
### Compliance por categoria (solo relevantes):
  ...
  * Tables: parcial (50%) -- Missing: table-scroll, table-sticky, table-head, cell-pad, sortable, sort-icon
  * Buttons: falta (38%) -- Missing: btn-ghost, btn-icon-flat, btn-icon-plus, btn-danger, btn-sm
  ...
  * Utilities: falta (0%) -- Missing: u-hidden, u-visible, text-right, text-xs, badge-quiet
...
### Hints de remediacion (priorizados):
  ...
  * MED: [Tables] Agregar: table-scroll, table-sticky, table-head, cell-pad, sortable, sort-icon
  ...
  * LOW: [Utilities] Agregar: u-hidden, u-visible, text-right, text-xs, badge-quiet

## Instrucciones

Crea un plan de implementacion para remediar operativo-workday.html al Golden Standard.
...
5. Si la pagina tiene CSS propio (ej: assets/css/operativo-workday.css), refactoriza ahi
